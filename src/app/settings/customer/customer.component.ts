...
export class CustomerComponent extends FullPagedListingComponentBase<CustomerDto> implements OnInit {
  ...
  protected list(request: FullPagedRequestDto, pageNumber: number, finishedCallback: Function): void {
    this._customerService.read(request)
      .subscribe(result => {
  ...
  showEditModal(id: any) {
    ...
    editCustomerDialog = this._modalService.show(
